...
export class CreateMuseoDto extends BasePatrimonialDto {
  @ApiPropertyOptional({
    example: 'Lunes a viernes de 08:00 a 17:00',
    description: 'Horario de atención del museo.',
    maxLength: 255,
  })
  @IsOptional()
  @IsString({
  ...
  @ApiPropertyOptional({
    ...
    description: 'Persona, unidad o institución responsable del museo.',
    maxLength: 150,
  })
  @IsOptional()
  @IsString({
  ...
  @ApiPropertyOptional({
    ...
    description: 'Sitio web relacionado con el museo.',
    maxLength: 500,
  })
  @IsOptional()
  @IsString({
